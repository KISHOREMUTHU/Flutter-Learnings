...
import 'career_oriented_quiz.dart';

class AcademicsQuizPage extends StatefulWidget {
  const AcademicsQuizPage({Key? key}) : super(key: key);

  @override
  State<AcademicsQuizPage> createState() => _AcademicsQuizPageState();
}

class _AcademicsQuizPageState extends State<AcademicsQuizPage> {
                                ...
                                if (_formKey.currentState?.saveAndValidate() ?? false) {
                                  ...
                                  setState(() {
                                    academicQuizmark=academics!+preferredLocation!+furtherEducation!+markPercentage!+numberOfSubjects!;
                                        print(academicQuizmark);
                                  });
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => CareerOrientedQuiz(academicQuizmark: academicQuizmark,)));
                                } else {
                                  debugPrint(_formKey.currentState?.value.toString());
